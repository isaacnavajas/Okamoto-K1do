...
<html lang="en">
  <head>
    ...
    <meta name="description" content="En esta página encontrarás el login donde poder loguearte una vez te hayas registrado para disfrutar de tus favoritos de recetas de okamoto.">
  ...
  <body>
    ...
    <div class="container-fluid ">
        ...
        <div class="fondoNegro">
            <div class="container">
                <div class="row">
                    <h2 class="titulo-japon-oscuro bloqueRecetasTexto">Acceso a mi cuenta</h2>
                            ...
                            <br>
                                <div class="bloqueRecetasTexto">
                                    ...
                                    <form method="POST" action="{{route("inicia-sesion")}}">
                                        ...
                                        <div>
                                        <p>¿No tienes cuenta? <a href="{{route('registro')}}" style="color:#f54545;">
                                        Regístrate</a></p>
                                        </div>
                                        <button type="submit" class="botonNegro" >Acceder</button>
        ...
        <div class="fondoBlanco">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <img src="{{asset('/images/web/historia.png')}}" alt="¿conoces la historia de Okamoto Kido?" class="imagenBloque">
                    </div>
        ...
        <div class="container-fluid ">
            <div class="col-12">
                <div class="row filtro-gris" id="parallax-login">
